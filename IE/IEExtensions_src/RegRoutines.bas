...
Public Function GetChildKey() As String
    ...
    Call RegOpenKey(HKEY_LOCAL_MACHINE, "Software\NetScape\Netscape Navigator", lngRegKey)

   
    If RegEnumKey(lngRegKey, intKey, strKey, 255) = 0 Then
       GetChildKey = Left(strKey, InStr(strKey, Chr(0)) - 1)
    End If
